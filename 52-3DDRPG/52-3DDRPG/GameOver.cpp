	...
	bright(0)
{
	...
	font[0] = CreateFontToHandle("Game Over", 25, 1, DX_FONTTYPE_ANTIALIASING_EDGE_4X4, DX_CHARSET_DEFAULT);
	font[1] = CreateFontToHandle("Game Over", 100, 1, DX_FONTTYPE_ANTIALIASING_EDGE_4X4, DX_CHARSET_DEFAULT);
